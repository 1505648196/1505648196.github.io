...
public class UserController {
    ...
    public List<User> show() {
        // 传统方式 mybatis
        //Page<User> puser = userService.getListByPage(new Page<User>(0,10));

        // 推荐用下面的方式  mybatisplus
           //userDao.getListByPage2(new Page<User>(0,2));
        return  userDao.getListByPage2(new Page<User>(0,7));
